                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="jumlah_stok" name="jumlah_stok" class="form-control" min="0"
                                value="{{ old('jumlah_stok', $alat->jumlah_stok) }}" required>
                        </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body d-flex flex-column gap-4">
                    <div>
                        ...
                        <select name="gambar_alat_id" id="gambar_alat_id" class="form-select d-none" aria-hidden="true">
                            ...
                            @foreach ($files as $file)
                                ...
                                @endphp
                                <option value="{{ $file->id }}" data-preview="{{ $fp }}"
                                    data-name="{{ $fn }}"
                        ...
                        <button type="button"
                            class="btn btn-outline-danger btn-sm mt-2 {{ $selectedFileId ? '' : 'd-none' }}"
                            id="alatFileClear">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-auto">
                        <a href="{{ route('alat.list') }}" class="btn btn-outline-theme">Batal</a>
