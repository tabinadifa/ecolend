...
@section('title', 'Detail Riwayat Peminjaman - Peminjam')
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div>
            ...
            <h1 class="page-title fw-bold mb-1">Detail Peminjaman</h1>
            <p class="text-muted mb-0">Informasi lengkap terkait peminjaman alat Anda.</p>
        </div>
        <a href="{{ route('peminjam.riwayat.list') }}" class="btn btn-outline-secondary">
            Kembali ke Riwayat
        </a>
    </div>
    ...
    <div class="row g-4">
        <div class="col-lg-7">
            <div class="card detail-card mb-4">
                <div class="card-body">
                    ...
                    <table class="table table-borderless align-middle mb-0">
                        ...
                        <tr>
                            <th class="info-label">Jumlah</th>
                            <td>{{ $peminjaman->total_alat ?? '-' }}</td>
                        </tr>
                        @if ($status === 'rejected' && $peminjaman->alasan_ditolak)
                            <tr>
                                <th class="info-label align-top">Alasan Ditolak</th>
            ...
            <div class="card detail-card">
                <div class="card-body">
                    <h5 class="fw-semibold mb-3">Pengembalian</h5>
                    @if ($pengembalian)
                        <table class="table table-borderless align-middle mb-0">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $pengembalian->kondisi_alat ? ucfirst($pengembalian->kondisi_alat) : '-' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="info-label">Status Denda</th>
                                <td>{{ $pengembalian->status ? ucfirst($pengembalian->status) : 'Tidak ada denda' }}</td>
                            </tr>
                            <tr>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center text-muted py-4">
                            ...
                            <p class="mb-0">Belum ada bukti pengembalian.</p>
                        </div>
                    @endif
                </div>
            </div>
